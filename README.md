...
- Stage 1 prompts an LLM (OpenAI Chat Completions) to fill application, environment, port, and volume descriptions in English.  
...
| Flag | Description |
| ---- | ----------- |
| `--stage` | `1` / `2` / `all` selects the pipeline stage；选择执行阶段。 |
