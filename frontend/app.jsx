          ...
          if (!state.params.dirty && action.engine?.meta?.app) {
            ...
            nextState.params = {
              ...
              draft: {
                ...
                releaseNotes: app.releaseNotes || nextState.params.draft.releaseNotes,
                category: app.category || nextState.params.draft.category,
                version: app.version || nextState.params.draft.version,
                updateAt: app.updateAt || nextState.params.draft.updateAt,
                website: app.website || nextState.params.draft.website,
                repo: app.repo || nextState.params.draft.repo,
                support: app.support || nextState.params.draft.support,
                docs: app.docs || nextState.params.draft.docs,
    ...
    function App() {
      ...
      const buildParamsPayload = () => ({
        app: {
          ...
          releaseNotes: String(state.params.draft.releaseNotes || "").trim(),
          category: String(state.params.draft.category || "").trim(),
          version: String(state.params.draft.version || "").trim(),
          updateAt: String(state.params.draft.updateAt || "").trim(),
          website: String(state.params.draft.website || "").trim(),
          repo: String(state.params.draft.repo || "").trim(),
          support: String(state.params.draft.support || "").trim(),
          docs: String(state.params.draft.docs || "").trim(),
